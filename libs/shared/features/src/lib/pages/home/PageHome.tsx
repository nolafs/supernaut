...
export function PageHome({navigation, footer, slider, quotes, contentColumn}: PageHomeProps) {
  return (
    <div>
      ...
      <Section internalName={'intro'} marginTop={true} marginBottom={true} mode={'dark'}>
        <ContentColumn title={contentColumn.title} body={contentColumn.body} label={contentColumn.label} url={contentColumn.url}  />
      </Section>
