    ...
    if(wide){
      return (<div className={cn("relative card-wide bg-black overflow-hidden mb-7")}>
        <Image
               ...
               className={'object-cover w-full h-full group-hover:brightness-75 transform-gpu transition-all duration-500 ease-in-out'}/>
        {(!image) &&
          ...
          <div className={cn("relative card-normal overflow-hidden bg-black max-w-[580px] max-h-[580px] mb-4")}>
            <Image
              ...
              alt={`Image: ${title}` || ''} width={580} height={580}
                   className={'relative object-cover w-full h-full group-hover:brightness-75  transform-gpu transition-all duration-500 ease-in-out'}/>
