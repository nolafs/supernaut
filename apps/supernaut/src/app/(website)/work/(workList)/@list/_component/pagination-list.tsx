...
export function PaginationList() {
  ...
  return (
    <div className={'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-3 gap-y-5 md:gap-x-4 md:gap-y-7 lg:gap-x-5 lg:gap-y-10 mt-16 mb:mt-20 mb-10 md:mb-20'}>
